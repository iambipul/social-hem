Meteor.publish('productFeeds', function(limit) {
  return ProductFeeds.find({});//, {limit: limit});//, {sort: {createdAt: -1}, limit: 200});
});
...
Meteor.startup(function () {
  ...
  collectionApi.addCollection(ProductFeeds, 'productFeeds');
  collectionApi.start();
});